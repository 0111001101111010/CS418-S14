...
<div class="content">
    ...
    <div class="login">
      <form role="form" method="post" action="loginCheck.php">
        ...
        <div class="checkbox">
          <input type="checkbox" value=1 name="checkbox" id="checkbox" checked="checked"> Remember Me
        </div>
        <hr>
        <center>
          <a class="btn btn-blue" name="signup" href="registration.php">Sign Up</a>
          <button type="submit" class="btn btn-blue" name="submit">Submit</button><br><br>

...
INSERT INTO reply (reply_id,reply_user,reply_thread_id,reply_reply_id,reply_reply_to_id ,reply_title,reply_post,reply_date) values (null,'TEST3',1, 0,-1, 'test2 title','NOTHING LIKE THE REST ', NOW());
